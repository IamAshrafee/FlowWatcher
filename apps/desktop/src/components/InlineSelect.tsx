...
export function InlineSelect<T extends string>({ value, options, onChange }: InlineSelectProps<T>) {
          ...
          {options.map((opt) => (
            <button
              ...
              style={{
                ...
                backgroundColor: opt.value === value ? 'rgba(58, 186, 180, 0.1)' : 'transparent',
                border: 'none',
                cursor: 'pointer',
                transitionDuration: 'var(--transition-fast)',
              }}
