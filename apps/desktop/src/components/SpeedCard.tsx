...
export function SpeedCard({ label, bps, icon, history = [], interfaceName }: SpeedCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Speed value */}
      <p className="mt-2 text-3xl font-bold tabular-nums" style={{ color: 'var(--color-accent)' }}>
        {value}
      </p>
